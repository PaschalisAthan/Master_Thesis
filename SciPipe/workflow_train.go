...
func main() {
	...
	trainModels := wf2.NewProc("train_models", `java -jar /home/paat9648/Workflow/cpsign-0.7.8.jar train \
												--license /home/paat9648/Workflow/cpsign0x-std-building.license \
